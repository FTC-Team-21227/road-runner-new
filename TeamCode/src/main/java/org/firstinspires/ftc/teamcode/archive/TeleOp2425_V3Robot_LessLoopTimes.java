...
//@TeleOp(name = "TeleOp2425_V3Robot_LessLoopTimes")
public class TeleOp2425_V3Robot_LessLoopTimes extends LinearOpMode {
    ...
    private final double enter1 = 8.1777;
    ...
    private final double enter2 = 154.721207477;
...
//                telemetry.addData("ARM2 Pressed:",ARM2Sensor.isPressed());
                ...
                telemetry.addData("ARM1 Power", power1);
                telemetry.addData("ARM2 Power", power2);
