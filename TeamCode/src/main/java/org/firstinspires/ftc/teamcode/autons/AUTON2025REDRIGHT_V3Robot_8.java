...
@Autonomous(name = "AUTONRIGHT_V3_5+1_NewStratss")
...
//        pushing timing to the limits
        ...
        TrajectoryActionBuilder tab3 = drive.actionBuilder(new Pose2d(50, -55, Math.toRadians(90))) //push colored samples
                .strafeTo(new Vector2d(60,-55));
        TrajectoryActionBuilder tab4 = drive.actionBuilder(new Pose2d(60, -55, Math.toRadians(90))) //push colored samples
                .strafeTo(new Vector2d(65,-55))
                .waitSeconds(2.2)
                .turnTo(Math.toRadians(60));
        TrajectoryActionBuilder tab5 = drive.actionBuilder(new Pose2d(65, -55, drive.localizer.getPose().heading.toDouble())) //go to second specimen
        ...
        TrajectoryActionBuilder tab6 = drive.actionBuilder(new Pose2d(67, -60, Math.toRadians(-90))) //pick up and place second specimen
                ...
                .waitSeconds(0.4)
                .splineToLinearHeading(new Pose2d(5.5,firstSpecDistance,Math.toRadians(90)),Math.toRadians(90));
        ...
        Actions.runBlocking(
                new SequentialAction(
                        ...
                        new ParallelAction(
                                ...
                                arm1.liftRung_First(1.5),
                                arm2.liftRung2_First(1.5),
                                firstTrajectory
                        ),
                        new ParallelAction(
                                claw.openClawMore(),
                                intake_angle.RotatePosition2(0.5),
                                secondTrajectory,
                                intake_angle.RotatePosition0_left(2.0),
                                arm1.waitLiftFloor(2.0,1),
                                arm2.waitLiftFloor(2.0,1)
                        ),
                        claw.closeClaw(),
                        new ParallelAction(
                                arm1.waitLiftRung2(0.4,1.2),
                                arm2.waitLiftDown(0.4,1.2),
                                thirdTrajectory
                        ),
                        claw.openClaw(),
                        new ParallelAction(
                        ...
                        new ParallelAction(
                                ...
                                arm2.waitLiftDown(0.4,1.2),
                                claw.openClaw(1.6),
                                arm1.waitLiftFloor(1.6,1.2),
                                arm2.waitLiftFloor(1.6,1.2),
                                claw_angle.backward(),
                                fourthTrajectory
                        ),
                        claw.closeClaw(),
                        new ParallelAction(
                                arm1.liftWall_First(1.6),
                                arm2.liftWall2_First(1.6),
                                claw_angle.forward(),
                        ...
                        new ParallelAction(
                                arm1.waitLiftRung_First(0.3),
                                arm2.waitLiftRung2_First(0.3),
                                sixthTrajectory,
                                intake_angle.RotatePosition3(0.4)
                        ),
        ...
        PoseStorage.currentPose = new Pose2d(
                -drive.localizer.getPose().position.y,                  // New x becomes original y (rotation)
                drive.localizer.getPose().position.x,                 // New y becomes negative original x (rotation)
