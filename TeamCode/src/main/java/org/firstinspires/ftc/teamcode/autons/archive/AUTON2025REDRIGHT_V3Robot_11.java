...
//public class AUTON2025REDRIGHT_V3Robot_11 extends LinearOpMode {
//    @Override
...
//                                arm1.liftRung_First(1.3),
//                                arm2.liftRung2_First(1.3),
//                                firstTrajectory
//                        ),
//                        new ParallelAction(
//                                claw.openClawMore(),
...
//                                arm1.waitLiftFloor(1.5,1),
//                                arm2.waitLiftFloor(1.5,1),
//                                claw.closeClaw(2.3)
//                        ),
//                        new ParallelAction(
//                                arm1.waitLiftRung2(0.2,1.2),
//                                arm2.waitLiftDown(0.2,1.2),
//                                claw.openClaw(1),
//                                thirdTrajectory
//                        ),
//                        new ParallelAction(
...
//                                claw.openClaw(1.8),
//                                arm1.waitLiftFloor(2.6,1.2),
//                                arm2.waitLiftFloor(2.6,1.2),
//                                claw_angle.backward(0.4),
//                                fourthTrajectory,
//                                claw.closeClaw(3.6)
//                        ),
//                        new ParallelAction(
//                                arm1.waitLiftWall_First(0.2,1.4),
//                                arm2.waitLiftWall2_First(0.2,1.4),
...
//                        new ParallelAction(
//                                arm1.waitLiftRung_FirstSecond(0.2),
//                                arm2.waitLiftRung2_First(0.2),
//                                sixthTrajectory,
...
//                                claw.openClawMore(),
//                                seventhTrajectory,
//                                arm1.waitLiftFloor(0.2,1.5), //0.5
//                                arm2.waitLiftFloor(0.2,1.5),
...
//                        claw.closeClaw(),
//                        new ParallelAction(
//                                arm1.waitLiftRung2(0.2,1.7),
//                                arm2.waitLiftRung2(0.2,1.7),
//                                eighthTrajectory,
...
//                        claw.closeClaw(),
//                        new ParallelAction(
//                                arm1.waitLiftRung2(0.2,1.7), //0.3
//                                arm2.waitLiftRung2(0.2,1.7),
//                                tenthTrajectory,
//                                claw_angle.forward(0.5)
//                        ),
