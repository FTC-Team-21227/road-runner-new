...
@Disabled
@Autonomous(name = "REDRIGHT_6spec_CV_Bad")
public class AUTON2025REDRIGHT_V4Robot_8_Bad extends LinearOpMode {
    @Override
...
//                .splineToConstantHeading(new Vector2d(pose_X,firstSpecDistance),Math.toRadians(90));
        ...
        TrajectoryActionBuilder tab5 = drive.actionBuilder(new Pose2d(41+frictionConstant,-56, Math.toRadians(-15))) //first specimen
                .setTangent(Math.toRadians(90))
...
//                .splineToConstantHeading(new Vector2d(7.5,otherSpecDistance),Math.toRadians(90));
        ...
        TrajectoryActionBuilder tab7 = drive.actionBuilder(new Pose2d(5.5, otherSpecDistance, Math.toRadians(-90))) //go to third specimen
                .setTangent(Math.toRadians(-90))
//                .strafeTo(new Vector2d(40,wallGrab));
...
//                .splineToConstantHeading(new Vector2d(8.5,otherSpecDistance),Math.toRadians(90));
        ...
        TrajectoryActionBuilder tab9 = drive.actionBuilder(new Pose2d(7.5, otherSpecDistance, Math.toRadians(-90))) //go to third specimen
                .setTangent(Math.toRadians(-90))
//                .strafeTo(new Vector2d(40,wallGrab+0.3));
        ...
        TrajectoryActionBuilder tab11 = drive.actionBuilder(new Pose2d(10, otherSpecDistance, Math.toRadians(-90))) //go to third specimen
                .setTangent(Math.toRadians(-90))
//                .strafeTo(new Vector2d(40,wallGrab+0.6));
...
//                .strafeTo(new Vector2d(40,wallGrab+0.6));
        ...
        Action secondTrajectory = drive.actionBuilder(color_pose) //push colored samples
                .setTangent(Math.toRadians(-90))
                .waitSeconds(0.3)
                .splineToConstantHeading(new Vector2d(pose_X,-52),Math.toRadians(-90))
//                .splineToConstantHeading(new Vector2d(15,-54),Math.toRadians(-45))
                .splineToSplineHeading(new Pose2d(41+frictionConstant, -56,Math.toRadians(-15)),Math.toRadians(0))
                .build();
        Actions.runBlocking(
                new SequentialAction(
            new ParallelAction(
        ...
        Actions.runBlocking(
                new SequentialAction(
                        ...
                        new ParallelAction(
                                ...
                                arm1.liftDown(0.2),
                                arm2.liftDown(0.2),
                                arm1.liftWall2_First(7.5,1.4),
                                arm2.liftWall2(7.5,1.4),
                                claw_angle.backward(7.5),
                                intake_angle.RotatePositionNegative1(8.2),
                                sweeper.RotatePosition0(7.2)
                        ),
                        claw.closeClaw()
                )
        );
