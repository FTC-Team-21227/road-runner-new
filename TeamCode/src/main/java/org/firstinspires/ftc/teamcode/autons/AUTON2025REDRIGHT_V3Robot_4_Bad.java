...
@Disabled
@Autonomous(name = "RIGHT_5+1_Bad")
//Trying for 5+1 auto just by pushing the samples faster
public class AUTON2025REDRIGHT_V3Robot_4_Bad extends LinearOpMode {
    @Override
...
//                .splineToConstantHeading(new Vector2d(35.5,-22),Math.toRadians(90))
                .splineToConstantHeading(new Vector2d(41+frictionConstant, -45),Math.toRadians(0))
                .setTangent(Math.toRadians(90))
...
//                .strafeTo(new Vector2d(50, -48))
                ...
                .splineToConstantHeading(new Vector2d(69,-44.5),Math.toRadians(-90));
