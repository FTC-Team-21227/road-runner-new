...
public class AUTON2025BLUERIGHT_V4Robot_2 extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        PipeCamera cam = new PipeCamera(hardwareMap,telemetry,true,"blue", false);
        ...
        Actions.runBlocking(
                new SequentialAction(
                        ...
                        new ParallelAction(
                                ...
                                arm1.liftRung2(0.3,2.0, false),
                                arm2.liftRung2(0.3, 2.0, false),
                                sixthTrajectory,
                        ...
                        new ParallelAction(
                                arm1.liftRung2(0.1,1.5, false),
                                arm2.liftRung2(0.1,1.5, false),
                                eighthTrajectory,
