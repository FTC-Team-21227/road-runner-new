...
//                //field centric drive??
//                Rotation2d inverseHeading = drive.localizer.getPose().heading.inverse();
...
//                        ));
//                        currHeading = drive.localizer.getPose().heading.toDouble();
//                    }
//                    else{
//                        double rotPower = headingController.calculate(drive.localizer.getPose().heading.toDouble(), currHeading);
//                        drive.setDrivePowers(new PoseVelocity2d(
//                                inverseHeading.times(new Vector2d(
//                                        x * mag,
//                                        y * mag
...
//                    initialPose = new Pose2d(new Vector2d(drive.localizer.getPose().position.x,drive.localizer.getPose().position.y),Math.toRadians(0));
//                }
