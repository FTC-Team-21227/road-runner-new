...
@Disabled
@Autonomous(name = "BLUELEFT_5samp_CV_NEEDS UPDATE")
//5 sample auto
public class AUTON2025BLUELEFT_V4Robot_3 extends LinearOpMode{
    @Override
    public void runOpMode() throws InterruptedException {
        ...
        PipeCamera cam = new PipeCamera(hardwareMap,telemetry,false,"blue",true);
        ...
        PoseStorage.grabYellowPose = new Pose2d(66.5+Y, 90-X,Math.toRadians(-90));
...
//                .strafeTo(new Vector2d(10.5, 122.5)); //get 1st sample
        ...
        TrajectoryActionBuilder tab9 = drive.actionBuilder(new Pose2d(7, 113.5, Math.toRadians(-45)))
                .waitSeconds(0.5)
                .strafeToSplineHeading(new Vector2d(66.5+Y,105),Math.toRadians(-90), new TranslationalVelConstraint(70))
//                .waitSeconds(1.5) //get 4th sample from the sub
                .strafeTo(new Vector2d(66.5+Y, 90-X/*+2*/), new TranslationalVelConstraint(30)); //get 4th sample
//                .strafeTo(new Vector2d(66.5+Y,90-X),new TranslationalVelConstraint(30));
        TrajectoryActionBuilder tab10 = drive.actionBuilder(new Pose2d(66.5+Y,90-X, Math.toRadians(-90)))
                .setTangent(Math.toRadians(180))
                .waitSeconds(0.3) //change0.5
                .splineToConstantHeading(new Vector2d(66.5,100),Math.toRadians(180), new TranslationalVelConstraint(70))
                .splineToSplineHeading(new Pose2d(3, 112, Math.toRadians(-45)), Math.toRadians(165),new TranslationalVelConstraint(70)) //go away from wall bec arms lifting
                .waitSeconds(0.7);//change0.7
        TrajectoryActionBuilder tab13 = drive.actionBuilder(new Pose2d(3,112,Math.toRadians(-45)))
                ...
                .splineToConstantHeading(new Vector2d(52.5, 94),Math.toRadians(0),new TranslationalVelConstraint(15)); //touch bar
...
//                .splineToConstantHeading(new Vector2d(66.5, 87),Math.toRadians(-45),new TranslationalVelConstraint(15)); //touch bar
...
//                    arm2.waitLiftVertFloor(4,0.7)
        ...
        Action toYellow1 = drive.actionBuilder(new Pose2d(66.5+Y, 90-X/*+2*/, Math.toRadians(-90))) //push colored samples
