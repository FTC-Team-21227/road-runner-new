...
@Config
public final class PinpointLocalizer_intake implements Localizer {
    public static class Params {
        public double parYTicks = 3118.61492666645; // y position of the parallel encoder (in tick units)
        public double perpXTicks = -36.5/MecanumDrive_Lock.PARAMS.inPerTick; // x position of the perpendicular encoder (in tick units)
    }
    ...
    public PinpointLocalizer_intake(HardwareMap hardwareMap, double inPerTick, Pose2d initialPose) {
