...
@Config
public final class MecanumDrive_Lock {
    public static class Params {
        ...
        public double inPerTick = 0.0020111089829535;
        public double lateralInPerTick = 0.001594331937488578;
        public double trackWidthTicks = 6494.654176171068;

        // feedforward parameters (in tick units)
        public double kS = 0.7775495096096779;
        public double kV = 0.00035527841995;
        public double kA = 0.000055;

        // path profile parameters (in inches)
        public double maxWheelVel = 80; //70;
        public double minProfileAccel = -40;
        public double maxProfileAccel = 100; //60;
    ...
    public class DriveLocalizer implements Localizer {
        ...
        public DriveLocalizer(Pose2d pose) {
            leftFront = new OverflowEncoder(new RawEncoder(MecanumDrive_Lock.this.leftFront));
            leftBack = new OverflowEncoder(new RawEncoder(MecanumDrive_Lock.this.leftBack));
            rightBack = new OverflowEncoder(new RawEncoder(MecanumDrive_Lock.this.rightBack));
            rightFront = new OverflowEncoder(new RawEncoder(MecanumDrive_Lock.this.rightFront));
    ...
    public MecanumDrive_Lock(HardwareMap hardwareMap, Pose2d pose) {
        ...
        leftFront = hardwareMap.get(DcMotorEx.class, "W_FL");
        leftBack = hardwareMap.get(DcMotorEx.class, "W_BL");
        rightBack = hardwareMap.get(DcMotorEx.class, "W_BR");
        rightFront = hardwareMap.get(DcMotorEx.class, "W_FR");
        ...
        localizer = new PinpointLocalizer_intake(hardwareMap, PARAMS.inPerTick, pose);
//        localizer = new TwoDeadWheelLocalizer(hardwareMap, lazyImu.get(), PARAMS.inPerTick, pose);
    ...
    public final class FollowTrajectoryAction2 implements Action {
        public final TimeTrajectory timeTrajectory;
        private double beginTs = -1;

        private final double[] xPoints, yPoints;

        public FollowTrajectoryAction2(TimeTrajectory t) {
            timeTrajectory = t;
    ...
    public final class TurnAction_Lock implements Action {
        private final TimeTurn turn;

        private double beginTs = -1;
        private final BooleanSupplier continueCondition;

        public TurnAction_Lock(TimeTurn turn, BooleanSupplier continueCondition) {
            this.turn = turn;
            this.continueCondition = continueCondition;
        }
...
//                t -> new FollowTrajectoryAsPathAction(t, continueCondition),
    ...
    public TrajectoryActionBuilder actionBuilder2(Pose2d beginPose) {
        return new TrajectoryActionBuilder(
                TurnAction::new,
//                FollowTrajectoryAsPathAction::new,
                FollowTrajectoryAction2::new,
                new TrajectoryBuilderParams(
                        1e-6,
                        new ProfileParams(
                                0.25, 0.1, 1e-2
    ...
    public final class FollowTrajectoryAsPathAction implements Action {
        ...
        public FollowTrajectoryAsPathAction(TimeTrajectory t, BooleanSupplier continueCondition) {
        ...
        public boolean run(@NonNull TelemetryPacket p) {
            ...
            TelemetryPacket q = new TelemetryPacket();
            q.addLine("x");
