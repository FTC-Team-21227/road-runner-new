...
@TeleOp(name = "TeleOp2425_V3Robot_MotionProfile")
public class TeleOp2425_V3Robot_MotionProfile extends LinearOpMode {
    ...
    double target1 = 0;
    double target2 = 0;
    double Target1 = target1;
    double Target2 = target2;
        ...
        if (opModeIsActive()) {
            ...
            while (opModeIsActive()) {
                ...
                if (gamepad1.back && !back) {
                    drive = new MecanumDrive_Lock(hardwareMap,new Pose2d(0,0,0));
                    try {
                        Thread.sleep(300);
