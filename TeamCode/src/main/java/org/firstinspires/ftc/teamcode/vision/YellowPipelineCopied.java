...
//@Config
public class YellowPipelineCopied extends OpenCvPipeline {
    private Telemetry packet = null;
    /*
...
//                minAreaRect.points(box); // Get the rectangle's corner points
                ...
                if (height != 0) {  // Avoid division by zero
                    ...
                    packet.addData("aspecticor", aspectRatio);
...
//                            double consta = expectH/ coords[2];
                            ...
                            packet.addData("CAM X", coords[0]);
                            packet.addData("CAM y", coords[1]);
                            packet.addData("CAM Z", coords[2]);
                            packet.addData("classif", classify);
                            packet.addData("aspectRatio", aspectRatio);
                            packet.addData("area", Imgproc.contourArea(contour));
...
//                            double consta = expectH/ coords[2];
                                    ...
                                    packet.addData("CAM X", center[0]);
                                    packet.addData("CAM y", center[1]);
                                    packet.addData("CAM Z", center[2]);
                                    packet.addData("classif", classify);
                                    packet.addData("aspectRatio", aspectRatio);
                                    packet.addData("area", Imgproc.contourArea(contour));
